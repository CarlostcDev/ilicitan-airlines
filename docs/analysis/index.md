...
- Check-in y la generación del billete del embarque.
...
El diagrama de Entidad-Relación Extendido contempla el diseño **inicial** de la estructura de los datos del sistema, encargado de formar un mapa visual entre las entidades y actores, sus atributos previstos y funcionalidades del sistema.
